...
DROP TABLE IF EXISTS `customer_banking`;
...
LOCK TABLES `customer_banking` WRITE;
/*!40000 ALTER TABLE `customer_banking` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_banking` ENABLE KEYS */;
UNLOCK TABLES;
